  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur ">
      <div className="container px-4 md:px-0 mx-auto flex h-16 items-center justify-between ">
       <Logo />
        <Button asChild variant="default" className="gap-2 rounded-sm group hover:scale-103 transition-transform" title="إضافة خدمة جديدة" aria-label="إضافة خدمة جديدة">
